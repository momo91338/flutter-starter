...
class SmsAuthenticationScreen extends StatefulWidget {
  ...
  @override
  SmsAuthenticationScreenState createState() =>
      SmsAuthenticationScreenState();
}
...
class SmsAuthenticationScreenState extends State<SmsAuthenticationScreen> {
  ...
  /// Logs in using code and phone number, then navigates to the authenticated screen on success
  Future<void> login() async {
    ...
    try {
      ...
      final result = await privyManager.privy.sms.loginWithCode(
        ...
        phoneNumber:
            phoneController.text.trim(), // The phone number to verify against
      );
